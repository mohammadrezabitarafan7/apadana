...
const Page = () => {
  return (
    <div className="flex relative flex-col gap-12 m-auto container p-12">
      {/* Header */}
      <div className="flex flex-row items-center justify-between">
        <h1 className="text-3xl text-[#1E1E1E] font-bold">مقالات منتشر شده</h1>
        <Link
          className="flex items-center gap-3 border border-[#4C4C4C] p-2 rounded-xl hover:"
          href="/articles"
        >
          <span className="text-base text-[#4C4C4C]">مشاهده همه</span>
          <ArrowIcon size={8} />
        </Link>
      </div>
      <Image className="absolute left-0 -z-40" width={180} height={50} alt="سالنامه آپادانا" src="/back1.png" />
      <Image className="absolute bottom-0 right-0 -z-40" width={180} height={50} alt="سالنامه آپادانا" src="/back1.png" />

      {/* Content */}
      <div className="grid grid-cols-12 gap-6 max-h-[483px]">
        {/* Left big card */}
        ...
        <div className="col-span-6 flex flex-col gap-6">
          {[1, 2].map((i) => (
            ...
            >
              <div className="col-span-4 w-[182px] h-[182px]">
                <Image
                  width={182}
                  height={182}
              ...
              <div className="col-span-8 flex flex-col justify-between gap-3 px-4">
